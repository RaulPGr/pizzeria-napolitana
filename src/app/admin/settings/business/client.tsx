  ...
  return (
    <div className="space-y-6 rounded-lg border bg-white p-4 shadow-sm">
      ...
      <div className="grid gap-4">
        ...
        <input className="border rounded px-3 py-2" placeholder="Pizzer�a napolitana" value={name} onChange={(e)=>setName(e.target.value)} />

        <label className="text-sm text-gray-700">Slogan</label>
        <input className="border rounded px-3 py-2" placeholder="La tradici�n de N�poles en cada porci�n." value={slogan} onChange={(e)=>setSlogan(e.target.value)} />
