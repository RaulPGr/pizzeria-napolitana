...
export default function BusinessSettingsClient() {
  ...
  async function addMember() {
    ...
    setMemberMsg(null);
    try {
      const payload: any = { email, role: memberRole };
      if (memberPassword.trim()) payload.password = memberPassword.trim();
      const t = getTenantFromUrl();
      const url = t ? `/api/admin/members?tenant=${encodeURIComponent(t)}` : '/api/admin/members';
  ...
  return (
    <div className="space-y-6 rounded-lg border bg-white p-4 shadow-sm">
      ...
      {msg && (
        <div className="rounded border p-2 text-sm" style={{ borderColor: '#cbd5e1', background: '#f8fafc' }}>
          {msg}
        </div>
      )}
      ...
      <div className="grid gap-4">
        ...
        <input
          className="border rounded px-3 py-2"
          placeholder="La tradición de Nápoles en cada porción."
          value={slogan}
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          <div>
            ...
            {biz?.logo_url && (
              <img src={biz.logo_url} alt="logo" className="h-16 w-auto rounded border mb-2" />
            )}
            <input
              type="file"
              accept="image/*"
          ...
          <div>
            ...
            {biz?.hero_url && (
              <img src={biz.hero_url} alt="hero" className="h-24 w-full object-cover rounded border mb-2" />
            )}
            <input
              type="file"
              accept="image/*"
      ...
      <div className="rounded border bg-white p-4">
        ...
        <p className="text-xs text-gray-600 mb-3">
          Crea cuentas para empleados con acceso al panel. Los usuarios creados aqui no son superadmins.
        </p>
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="text-xs text-gray-500">
        Añade 0, 1 o 2 tramos por día. Deja vacío para "Cerrado".
      </div>
